...
minetest.register_abm({
	...
	action = function(pos, node)
		farming:generate_tree_b(pos, "default:tree", "farming_plus:banana_leaves", {"default:dirt", "default:dirt_with_grass"}, {["farming_plus:banana"]=9})
	end
})
...
minetest.register_on_generated(function(minp, maxp, blockseed)
	...
	if pos ~= nil then
		farming:generate_tree_b({x=pos.x, y=pos.y+1, z=pos.z}, "default:tree", "farming_plus:banana_leaves",  {"default:dirt", "default:dirt_with_grass"}, {["farming_plus:banana"]=9})
	end
end)
