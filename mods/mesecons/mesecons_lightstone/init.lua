...
function mesecon:lightstone_add(name, base_item, texture_off, texture_on, desc)
	...
	minetest.register_craft({
		...
		recipe = {
			{"","default:glass",""},
			{base_item,"glowcrystals:glowdust",base_item},
...
mesecon:lightstone_add("darkgray", "dye:dark_grey", "jeija_lightstone_darkgray_off.png", "jeija_lightstone_darkgray_on.png", "Dark Gray Lightstone")
